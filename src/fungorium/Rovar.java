...
public class Rovar {
    ...
    public void eszik(Spora s) {
        ...
        allapotFrissites(s.getsporaType()); // Ãllapot frissítése a spóra típusa alapján
    }
